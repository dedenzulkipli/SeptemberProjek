          ...
          <div class="card-body p-5 text-center">
            ...
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <div class="form-outline form-white mb-4">
                <input type="text" id="typeUsernameX" class="form-control form-control-lg" name="name" required />
              ...
              <div class="form-outline form-white mb-4">
                <input type="password" id="typeConfirmPasswordX" class="form-control form-control-lg" name="password_confirmation" required />
                <label class="form-label" for="typeConfirmPasswordX">Confirm Password</label>
              </div>

              <!-- Upload Foto Field -->
              <!-- <div class="form-outline form-white mb-4">
                <input type="file" id="typePhotoX" class="form-control form-control-lg" name="photo" accept="image/*" required />
                <label class="form-label" for="typePhotoX">Upload Photo</label>
              </div> -->
