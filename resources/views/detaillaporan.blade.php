...
<body>
    <div class="container">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="btn-group">
                                <a href="/detaillaporan/delete/{{ $item->id }}" onclick="return confirm('Yakin ingin menghapus?')">
                                    <button class="btn btn-custom">Hapus</button>
                                </a>
                                <!-- <a href="/detaillaporan/edit/{{ $item->id }}">
        ...
        <div class="text-center mt-4">
            <a href="/detaillaporan/detailcreate" class="btn btn-primary">Tambah Laporan Baru</a>
        </div>
    </div>
